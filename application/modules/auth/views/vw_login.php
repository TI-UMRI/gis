  	...
  	<div class="pmd-card card-default pmd-z-depth">
		<div class="login-card">
			<form method="post" id="formLogin" autocomplete="off">	
				<div class="pmd-card-title card-header-border text-center">
					<div class="loginlogo">
						<a href="javascript:void(0);"><img src="<?php echo base_url('template/') ?>themes/images/logo-icon.png" alt="Logo"></a>
					</div>
		...
		<!-- <div class="register-card">
			...
			<form>	
			  ...
			  <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
				<a href="<?php echo base_url('template/') ?>index.html" type="button" class="btn pmd-ripple-effect btn-primary btn-block">Sign Up</a>
		...
		<!-- <div class="forgot-password-card">
			<form>	
			  ...
			  <div class="pmd-card-footer card-footer-no-border card-footer-p16 text-center">
			  	<a href="<?php echo base_url('template/') ?>index.html" type="button" class="btn pmd-ripple-effect btn-primary btn-block">Submit</a>
