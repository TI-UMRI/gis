							...
							<div class="pmd-card-body">	
								...
								<form id="formTambahLokasi" class="form-horizontal" role="form" method="POST" enctype="multipart/form-data">
									<div class="form-group pmd-textfield">
										...
										<div class="col-sm-10">
											<input name="objekNama" class="form-control input-sm" id="objekNama" required type="text">
										</div>
									</div>
									<div class="form-group pmd-textfield">
										<label for="objekAlamat" class="col-sm-2 control-label">Alamat Lokasi</label>
										<div class="col-sm-10">
										<textarea  name="objekAlamat"  class="form-control cssTextArea" required=""></textarea>
									...
									<div class="form-group pmd-textfield">
										...
										<div class="col-sm-10">
										<textarea name="objekJadwal" class="form-control cssTextArea" required=""></textarea>
										</div>
									</div>
									<div class="form-group pmd-textfield">
										<label for="objekKontak" class="col-sm-2 control-label">Kontak</label>
										<div class="col-sm-10">
											<input name="objekKontak" class="form-control input-sm" id="objekKontak" required type="text">
										</div>
									</div>
									...
									<div class="form-group pmd-textfield">
										...
										<div class="col-sm-5">
											<input name="objekLatitude" placeholder="latitude" class="form-control input-sm" id="objekLatitude" required type="text">
										</div>
										<div class="col-sm-5">
											<input name="objekLongitude" placeholder="longitude" class="form-control input-sm" id="objekLongitude" required type="text">
										</div>
									</div>

									<div class="form-group pmd-textfield">
										<label for="objekFoto" class="col-sm-2 control-label">Foto Lokasi</label>
										<div class="col-sm-10">
