...
<body>
	<div id="headerr"></div>
	<nav class="navbar navbar-inverse navbar-fixed-top pmd-navbar pmd-z-depth" id="navbarr">
		<div class="container-fluid">
			<div class=" notification  ">

				<a href="<?php echo base_url('auth') ?>" title="Login" class="dropdown-toggle pmd-ripple-effect" >
					<div  class="material-icons md-light pmd-sm">account_box</div>
				</a>
      ...
      <div class="navbar-header ">
       ...
       <a href="javascript:void(0);" class="navbar-brand ">Sistem Informasi Geografis Pemetaan Perkebunan Kelapa Sawit</a>
